...
var strategy = {
  ...
  init: function ()
  {
    ...
    this.trainer = new convnetjs.SGDTrainer(this.nn, {
      learning_rate: this.settings.NN.learning_rate,
      momentum: this.settings.NN.momentum,
    ...
    this.HODL = this.settings.hodl_threshold || 1;  
  ...
  check: function (candle)
  {
    ...
    else
    {
      ...
      if (this.predictionCount > this.settings.NN.min_predictions)
      {
        ...
        let guard_price = this.HODL * this.prevPrice;
        let canSell = currentPrice > this.prevPrice || currentPrice < guard_price;
        ...
        ('sell' !== this.prevAction && signal === true && meanAlpha < this.settings.NN.threshold_sell && canSell)
        {
